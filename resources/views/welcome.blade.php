...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('public/FE/images/favicon.ico') }}" rel="icon">
...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light"
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        ?>
                        @foreach ($data as $key)
                        <a href="{{ URL::to('shop/' . $key->category_id) }}"
                            class="nav-item nav-link">{{ $key->category_name }}</a>
                        @endforeach
                    </div>
                </nav>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    ...
                                    <a href="{{ URL::to('/check_out') }}" class="dropdown-item">Checkout</a>
                                    @if($user)
                                    <a href="{{ URL::to('/history_checkout?user_id=' . $user->id ) }}"
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="{{ URL::to('/cart') }}" class="btn px-0 ml-3">
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{ asset('public/FE/images/payments.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script src="{{ asset('public/FE/mail/jqBootstrapValidation.min.js') }}"></script>
    <script src="{{ asset('public/FE/mail/contact.js') }}"></script>
