...
<div class="col-md-12">
    <div class="card card-user">
        ...
        <div class="card-body">
            <form action="{{ URL::to('admin/update_product') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="product_desc"
                                class="form-control textarea">{{ $p->product_desc }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <br>
                <img style="width: 100px" src="{{ asset ('public/FE/images/' . $p->product_image ) }}" />
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id" id="cars">
                                @foreach($data as $key)
                                <option value="{{ $key->category_id }}" @if ($p->category_id ==
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="product_status" id="cars">
                                <option value="1" @if (old('1')==$p->product_status ) {{ 'selected' }} @endif>Hiện
                                </option>
                                <option value="0" @if (old('0')==$p->product_status ) {{ 'selected' }} @endif>Ẩn
                                </option>
                            </select>
                        </div>
                    </div>
